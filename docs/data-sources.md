...
| Nomad Drive | delisted Apple platform app | 已下架項目。 | 目前不作主展示。 |
...
2. 確認「現在的 Project」清單：Syncnext、eisonAI、TracklyReborn、aDict。
3. 確認「探索」清單：HLN Machine，以及是否還有其他 Notion/Drive/GitHub 裡的探索項目。
